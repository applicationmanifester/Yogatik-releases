...
async function triggerDownload(text, format = 'docx', defaultTitle = 'Document') {
  ...
  if (format === 'ppt' || format === 'pptx' || format === 'presentation') {
    ...
    container.innerHTML = `<style>body{font-family:'Calibri','Segoe UI',Inter,-apple-system,Roboto,sans-serif;color:#1e293b;font-size:11pt;line-height:1.6;}h1{font-size:20pt;color:#0f172a;border-bottom:2px solid #2563eb;padding-bottom:6px;margin:0 0 12px 0;}h2{font-size:15pt;color:#1e3a8a;margin:20px 0 8px 0;border-bottom:1px solid #e2e8f0;padding-bottom:4px;page-break-after:avoid;}h3{font-size:12.5pt;color:#0284c7;margin:14px 0 6px 0;page-break-after:avoid;}table{border-collapse:collapse;width:100%;margin:14px 0;page-break-inside:avoid;font-size:9.5pt;}th,td{border:1px solid #cbd5e1;padding:7px 10px;text-align:left;}th{background:#0f172a;color:#ffffff;font-weight:bold;}tr:nth-child(even){background:#f8fafc;}blockquote{border-left:4px solid #2563eb;margin:12px 0;padding:8px 14px;background:#eff6ff;color:#1e40af;page-break-inside:avoid;font-style:italic;}pre{background:#0f172a;color:#f8fafc;padding:12px;border-radius:6px;font-size:9pt;page-break-inside:avoid;}</style><div style='border-bottom:2px solid #0f172a;padding-bottom:8px;margin-bottom:16px;display:flex;justify-content:space-between;align-items:flex-end;'><div><h1 style='margin:0;font-size:20pt;'>${cleanTitle}</h1><p style='color:#64748b;font-size:8.5pt;margin:4px 0 0;'>Generated by Yogatik Intelligence Engine • ${new Date().toLocaleDateString(undefined, { year: 'numeric', month: 'long', day: 'numeric' })}</p></div><div style='font-size:8.5pt;color:#1e40af;font-weight:bold;letter-spacing:1px;text-transform:uppercase;'>Executive Report</div></div>${htmlBody}`
