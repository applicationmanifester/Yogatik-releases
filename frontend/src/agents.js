...
export const PRESET_AGENTS = [
  ...
  },
  {
    ...
    tools: ['clipboard_access', 'file_dialog', 'watch_folder', 'process_manager', 'terminal_run', 'system_state', 'screen_inspect', 'desktop_action', 'computer_control', 'browser_control', 'fs_read', 'fs_list', 'fs_write', 'proc_start', 'proc_output', 'proc_stop', 'watch', 'fs_undo', 'git_status'],
  },
  {
  ...
  },
  {
    ...
    system: 'You are an academic synthesis and paper recreation specialist. Search IEEE Transactions with ieee_venue_search and academic_search, find open access copies with unpaywall_pdf_resolver, analyze literature gaps with research_gap_analyzer, propose novel methodology with research_proposal_generator, bundle Overleaf projects with overleaf_packager, and generate complete IEEEtran LaTeX drafts with paper_regenerator.',
    tools: ['ieee_venue_search', 'academic_search', 'unpaywall_pdf_resolver', 'research_gap_analyzer', 'research_proposal_generator', 'paper_regenerator', 'overleaf_packager', 'bibtex_export', 'citation_graph', 'deep_research'],
  },
  {
    id: 'agent_reasoner',
    ...
    system: 'You are a formal logic and first-principles reasoning specialist. Break complex problems into explicit chain-of-thought steps, identify edge cases and false assumptions, solve symbolic equations with latex_equation_solver and math_eval, execute Python simulations with code_execute, and verify claims with formal proofs.',
    tools: ['latex_equation_solver', 'math_eval', 'code_execute', 'js_execute', 'deep_research', 'vector_search'],
  },
  {
    id: 'agent_modeller',
    ...
    system: 'You are a systems modelling and simulation architect. Model hardware architectures with verilog_testbench_generator, generate structural diagrams with diagram_render and mermaid, compute statistical equations with math_eval and code_execute, and visualize numerical results with chart.',
    tools: ['verilog_testbench_generator', 'diagram_render', 'chart', 'math_eval', 'code_execute', 'js_execute', 'data_convert'],
  },
  {
    id: 'agent_builder',
    ...
    system: 'You are a master software and system builder. Generate robust code, inspect and run builds with proc_start and proc_output, track versioning with git_status and git_diff, generate documentation with doc_generate, format markdown to HTML/PDF with md_to_pdf, and package deployment assets.',
    tools: ['code_execute', 'js_execute', 'git_status', 'git_diff', 'git_log', 'proc_start', 'proc_output', 'proc_stop', 'todo', 'fs_undo', 'doc_generate', 'md_to_pdf'],
  },
  {
    id: 'agent_socratic',
    ...
    system: 'You are a critical thinker, Socratic interrogator, and analytical evaluator. Challenge assumptions, run multi-agent peer review critiques with research_swarm_review, perform comparative trade-off analyses, ask structured clarifying questions, and deliver comprehensive diagnostic evaluations.',
    tools: ['research_swarm_review', 'research_gap_analyzer', 'deep_research', 'vector_search', 'diff'],
  },
  {
