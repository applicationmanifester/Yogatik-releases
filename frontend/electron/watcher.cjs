...
function registerWatcherIpc({ rootPathsFor }) {
...
module.exports = { registerWatcherIpc, startWatching, stopWatching, drainChanges, stopAll, noteEvent, RECURSIVE_SUPPORTED, DEBOUNCE_MS, path }
