...
function stopAllMcpStdioClients() {
  for (const name of [...servers.keys()]) stopServer(name)
}

function registerMcpStdioClientIpc() {
...
module.exports = { registerMcpStdioClientIpc, startServer, stopServer, stopAllMcpStdioClients }
